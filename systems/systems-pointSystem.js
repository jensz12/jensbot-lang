...
$.lang.register('pointsystem.add.success', 'Gav $1 til $2. Personen har nu $3.');
...
$.lang.register('pointsystem.makeitrain.success', 'Et kraftigt regnvejr er på vej! $1 har lige smidt $2 $3 op i luften!');
$.lang.register('pointsystem.makeitrain.usage', 'Anvendelse: !makeitrain [antal]');
...
$.lang.register('pointsystem.gift.usage', 'Anvendelse: !gift [bruger] [antal]');
$.lang.register('pointsystem.gift.shortpoints', 'Beklager! Du har ikke nok points til at kunne sende det som en gave!');
$.lang.register('pointsystem.gift.404', 'Sorry! That user does not seem to be registered with the chat yet!');
$.lang.register('pointsystem.gift.success', '$1 har sendt $2 til $3.');
